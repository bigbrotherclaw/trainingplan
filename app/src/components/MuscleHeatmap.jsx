    ...
    <div>
      <div className="flex justify-center gap-8 mb-4">
        <div className="text-center">
          ...
          <svg width="120" height="260" viewBox="0 0 160 340" className="max-w-full h-auto">
      ...
      <div className="flex justify-center items-center gap-2">
        ...
        <div className="w-24 h-2 rounded-full bg-gradient-to-r from-[#1e293b] via-[#0e7490] via-[#0891b2] to-[#ef4444]" />
